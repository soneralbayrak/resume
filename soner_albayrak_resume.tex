...
\begin{itemize}[noitemsep,nolistsep] 
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item[] Dissertation title: \emph{Analytical Studies in Fermion Conformal Bootstrap}\vspace*{-.5em}
		\end{itemize}
...
\end{itemize}
 ...
 \begin{itemize}%[itemsep=.04em] 
  	\item[] {\bf S.~Albayrak}, { S.~Kharel} and {D.~Meltzer}, \emph{On duality of color and kinematics in (A)dS momentum space}, \hyperref{https://arxiv.org/pdf/2012.10460.pdf}{category}{name}{arXiv:2012.10460 [hep-th]} (\emph{accepted to JHEP})
