...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\huge \textcolor{burntorange}{Soner Albayrak}} &\\
Middle East Technical University & Email : \href{mailto:contact@soneralbayrak.com}{contact@soneralbayrak.com}\\
Ankara 06800 & Phone : +90-312-210-3281\\
 Turkey & Web:  \href{http://www.soneralbayrak.com}{soneralbayrak.com}
\end{tabular*}
...
\end{itemize}
 ...
 \begin{itemize}%[itemsep=.04em] 
   	 \item[] {\bf S.~Albayrak} and {S.~Kharel}, \emph{Soft limits of gluon amplitudes in holography and cosmology}, \hyperref{https://inspirehep.net/literature/2850553}{}{}{JHEP 07 (2025) 019} 
...
\begin{itemize}
	...
	\item[] PHYS 332: \emph{Electromagnetic Theory II}\hfill Spring '25\hspace*{2.2em}\vspace*{-.3em}
	\item[] PHYS 331: \emph{Electromagnetic Theory I}\hfill Fall '25\hspace*{2.2em}\vspace*{-.3em}
	...
	\item[] PHYS 106: \emph{General Physics II}\hfill Spring '23, '25\hspace*{2.2em}\vspace*{-.3em}
	\item[] PHYS 105: \emph{General Physics I}\hfill Fall '23, '25\hspace*{2.2em}\vspace*{-.3em}
\end{itemize} 
...
\section{\textcolor{burntorange}{Conferences, Presentations, and Proceedings}}
\begin{itemize}[itemsep=.001em] 
\item[] 42. International Physics Congress, Heredot Cultural Center - Bodrum\hfill Sep 2026
\\
\hspace*{1.8em}Talk: \emph{Harmonic Analysis of Bosonic Conformal Field Theories}

\item[] Bootstrap 2026, London\hfill Aug 2026

\item[] 6. Yüksek Enerji Fiziği, Astrofizik ve Kozmoloji Çalıştayı (YEFAK 2026), Yıldız Teknik Üniversitesi - İstanbul\hfill June 2026
\\
\hspace*{1.8em}Invited Talk: \emph{Soft limits in holography and cosmology}

\item[] ODTÜ 70. Yıl Dönem Arası Seminerleri, METU - Ankara\hfill Feb 2026
\\
\hspace*{1.8em}Invited Talk: \emph{Şu Fiziği İndirgeyip de mi Kuramlasak Yoksa İndirgemeyip de mi Kuramlasak?}

\item[] AGEP-11 Kapanış Programı, METU NCC - Cyprus\hfill Nov 2025
\\
\hspace*{1.8em}Invited Talk: \emph{Teorik Fizikteki Problemler}

\item[] 41. International Physics Congress, Herodot Cultural Center - Bodrum\hfill Sep 2025
\\
\hspace*{1.8em}Talk: \emph{Soft Limits of Gluon Amplitudes in Holography and Cosmology}
\\
\hspace*{1.8em}Talk \& Full-text proceeding: \emph{A Geometric Approach to the Perturbative Unitarity in Cosmology}

\item[] Bootstrap 2025, ICTP – SAIFR\hfill Jul 2025

\item[] TEDx, ODTÜ Geliştirme Vakfı Lisesi - Ankara\hfill May 2025
\\
\hspace*{1.8em}Invited Talk: \emph{Navigating the Frontiers of Knowledge}
...
\paragraph{Active}
\begin{itemize}
    \item[] Referee, \emph{\hyperref{https://dergipark.org.tr/en/pub/ticaretfbd}{}{}{İstanbul Commerce University Journal of Science}}\hfill 2025-current
	...
	\item[] Member, \emph{\hyperref{https://www.cost.eu/actions/CA22113}{}{}{Cost Action 22113 - Fundamental challenges in theoretical physics (THEORY-CHALLENGES)}}\hfill 2023-current
\end{itemize}
\paragraph{Past}
\begin{itemize}
	\item[] Organizer, \emph{\hyperref{https://ostimteknik.edu.tr/en/event/bogazici-metu-ostimtech-feza-gursey-commemoration-day-09-july-2025-6491}{}{}{BOĞAZİÇİ-METU-OSTIMTECH Feza Gürsey Commemoration Day}}\hfill 2025\hspace*{2.2em}
