...
\begin{itemize}[noitemsep,nolistsep]
	\item[] \textbf{Middle East Technical University, Ankara, Turkey}\hfill 2023 - present
\vspace*{-.5em}
\begin{itemize}
	\item[] Doktor Öğretim Üyesi (Assistant Professor)
\end{itemize} 
...
\begin{itemize}[noitemsep,nolistsep] 
	\item[] \textbf{Yale University, New Haven, USA}\hfill Agu 2016 - Jun 2021
	\vspace*{-.5em}
	\begin{itemize}
...
\end{itemize}
 ...
 \begin{itemize}%[itemsep=.04em] 
 	 \item[] {\bf S.~Albayrak} and  { S.~Kharel}, \emph{All plus four point (A)dS graviton function using generalized on-shell recursion relation}, \hyperref{https://inspirehep.net/literature/2634747}{category}{name}{JHEP 05 (2023) 151} 
 	
  	\item[] {\bf S.~Albayrak}, Rajeev Erramilli, Zhijin Li, David Poland  and Yuan Xin, \emph{Bootstrapping $N_f=4$ conformal QED$_3$}, \hyperref{https://inspirehep.net/literature/1984752}{category}{name}{Phys.Rev.D 105 (2022)}
...
\vspace*{-.3em}
\begin{itemize}
	\item[] PHYS 209: \emph{Mathematical Methods in Physics I}\hfill Fall 2023\hspace*{2.2em}\vspace*{-.3em}
